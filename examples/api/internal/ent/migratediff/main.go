...
import (
	...
	"github.com/teamsillybees/initra/examples/api/internal/ent/migrate"
)
...
func main() {
	...
	if err != nil {
		log.Fatalf("usage: go run ./internal/ent/migratediff/main.go <name> [-env <env>] [-config-dir <dir>] [-dev-url <url>]: %v", err)
	}
