...
func (_c *SysRoleCreate) SetIsBuiltin(v bool) *SysRoleCreate {
	_c.mutation.SetIsBuiltin(v)
	return _c
}

// SetNillableIsBuiltin sets the "is_builtin" field if the given value is not nil.
func (_c *SysRoleCreate) SetNillableIsBuiltin(v *bool) *SysRoleCreate {
	if v != nil {
		_c.SetIsBuiltin(*v)
	}
	return _c
...
func (_c *SysRoleCreate) SetIsEnable(v bool) *SysRoleCreate {
	_c.mutation.SetIsEnable(v)
	return _c
}

// SetNillableIsEnable sets the "is_enable" field if the given value is not nil.
func (_c *SysRoleCreate) SetNillableIsEnable(v *bool) *SysRoleCreate {
	if v != nil {
		_c.SetIsEnable(*v)
	}
	return _c
...
func (_c *SysRoleCreate) defaults() {
	if _, ok := _c.mutation.IsBuiltin(); !ok {
		v := sysrole.DefaultIsBuiltin
		_c.mutation.SetIsBuiltin(v)
	}
	if _, ok := _c.mutation.IsEnable(); !ok {
		v := sysrole.DefaultIsEnable
		_c.mutation.SetIsEnable(v)
	}
...
func (_c *SysRoleCreate) check() error {
	...
	if _, ok := _c.mutation.IsBuiltin(); !ok {
		return &ValidationError{Name: "is_builtin", err: errors.New(`ent: missing required field "SysRole.is_builtin"`)}
	}
	if _, ok := _c.mutation.IsEnable(); !ok {
		return &ValidationError{Name: "is_enable", err: errors.New(`ent: missing required field "SysRole.is_enable"`)}
	}
	if _, ok := _c.mutation.SortID(); !ok {
