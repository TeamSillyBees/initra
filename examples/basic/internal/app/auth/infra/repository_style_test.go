...
// TestRepositorySourceUsesJetDotImports 验证 auth 仓储保持 go-jet dot import 风格且不回退到硬编码 SQL。
func TestRepositorySourceUsesJetDotImports(t *testing.T) {
	...
	require.Contains(t, content, `. "github.com/teamsillybees/initra/examples/basic/internal/gen/jet/table"`)
