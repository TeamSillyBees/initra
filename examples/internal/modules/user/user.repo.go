...
func (r *Repository) FindByID(ctx context.Context, id idgen.ID) (*User, error) {
...
func (r *Repository) Delete(ctx context.Context, id idgen.ID, operatorID idgen.ID) error {
...
func (r *Repository) findByIDWithClient(ctx context.Context, client *appent.Client, id idgen.ID) (*User, error) {
...
func (r *Repository) resolveRoleIDs(ctx context.Context, client *appent.Client, roleCodes []string) ([]idgen.ID, error) {
...
func (r *Repository) replaceUserRoles(ctx context.Context, client *appent.Client, userID idgen.ID, roleIDs []idgen.ID) error {
...
func (r *Repository) loadRoleCodes(ctx context.Context, client *appent.Client, userID idgen.ID) ([]string, error) {
	var rows []struct {
		Code string `json:"code"`
	}
	err := client.SysRole.Query().
...
func (r *Repository) loadRoleCodesByUserIDs(ctx context.Context, userIDs []idgen.ID) (map[idgen.ID][]string, error) {
