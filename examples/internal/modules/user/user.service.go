...
type userRepo interface {
	...
	FindByID(ctx context.Context, id idgen.ID) (*User, error)
	FindByUsername(ctx context.Context, username string) (*User, error)
	Page(ctx context.Context, input PageUsersDTO) ([]*User, int64, error)
	Update(ctx context.Context, user *User) error
	Delete(ctx context.Context, id idgen.ID, operatorID idgen.ID) error
}
...
func (s *Service) Get(ctx context.Context, id idgen.ID) (*User, error) {
...
// Delete 删除用户并清理缓存。
func (s *Service) Delete(ctx context.Context, id idgen.ID, operatorID idgen.ID) error {
