...
func (_u *SysRoleUpdate) SetSortID(v int32) *SysRoleUpdate {
...
func (_u *SysRoleUpdate) SetNillableSortID(v *int32) *SysRoleUpdate {
	if v != nil {
		_u.SetSortID(*v)
	}
	return _u
...
func (_u *SysRoleUpdate) AddSortID(v int32) *SysRoleUpdate {
...
func (_u *SysRoleUpdate) AddRoleMenuIDs(ids ...idgen.ID) *SysRoleUpdate {
...
func (_u *SysRoleUpdate) RemoveUserRoleIDs(ids ...idgen.ID) *SysRoleUpdate {
...
func (_u *SysRoleUpdate) RemoveRoleMenuIDs(ids ...idgen.ID) *SysRoleUpdate {
...
func (_u *SysRoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AddedSortID(); ok {
		_spec.AddField(sysrole.FieldSortID, field.TypeInt32, value)
	}
...
// SetSortID sets the "sort_id" field.
func (_u *SysRoleUpdateOne) SetSortID(v int32) *SysRoleUpdateOne {
	_u.mutation.ResetSortID()
	_u.mutation.SetSortID(v)
	return _u
}
...
// SetNillableSortID sets the "sort_id" field if the given value is not nil.
func (_u *SysRoleUpdateOne) SetNillableSortID(v *int32) *SysRoleUpdateOne {
	if v != nil {
		_u.SetSortID(*v)
	}
	return _u
...
// AddSortID adds value to the "sort_id" field.
func (_u *SysRoleUpdateOne) AddSortID(v int32) *SysRoleUpdateOne {
	_u.mutation.AddSortID(v)
	return _u
}
...
// AddRoleMenuIDs adds the "role_menus" edge to the SysRoleMenu entity by IDs.
func (_u *SysRoleUpdateOne) AddRoleMenuIDs(ids ...idgen.ID) *SysRoleUpdateOne {
	_u.mutation.AddRoleMenuIDs(ids...)
	return _u
}
...
// RemoveUserRoleIDs removes the "user_roles" edge to SysUserRole entities by IDs.
func (_u *SysRoleUpdateOne) RemoveUserRoleIDs(ids ...idgen.ID) *SysRoleUpdateOne {
	_u.mutation.RemoveUserRoleIDs(ids...)
	return _u
}
...
// RemoveRoleMenuIDs removes the "role_menus" edge to SysRoleMenu entities by IDs.
func (_u *SysRoleUpdateOne) RemoveRoleMenuIDs(ids ...idgen.ID) *SysRoleUpdateOne {
	_u.mutation.RemoveRoleMenuIDs(ids...)
	return _u
}
