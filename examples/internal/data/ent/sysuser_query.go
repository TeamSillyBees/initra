...
func (_q *SysUserQuery) QueryUserRoles() *SysUserRoleQuery {
...
func (_q *SysUserQuery) FirstID(ctx context.Context) (id idgen.ID, err error) {
	var ids []idgen.ID
...
func (_q *SysUserQuery) FirstIDX(ctx context.Context) idgen.ID {
...
func (_q *SysUserQuery) OnlyID(ctx context.Context) (id idgen.ID, err error) {
	var ids []idgen.ID
...
func (_q *SysUserQuery) OnlyIDX(ctx context.Context) idgen.ID {
...
func (_q *SysUserQuery) IDs(ctx context.Context) (ids []idgen.ID, err error) {
...
func (_q *SysUserQuery) IDsX(ctx context.Context) []idgen.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *SysUserQuery) WithUserRoles(opts ...func(*SysUserRoleQuery)) *SysUserQuery {
	query := (&SysUserRoleClient{config: _q.config}).Query()
...
//		GroupBy(sysuser.FieldDeletedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *SysUserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*SysUser, error) {
	...
	if query := _q.withUserRoles; query != nil {
		if err := _q.loadUserRoles(ctx, query, nodes,
			func(n *SysUser) { n.Edges.UserRoles = []*SysUserRole{} },
			func(n *SysUser, e *SysUserRole) { n.Edges.UserRoles = append(n.Edges.UserRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *SysUserQuery) loadUserRoles(ctx context.Context, query *SysUserRoleQuery, nodes []*SysUser, init func(*SysUser), assign func(*SysUser, *SysUserRole)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[idgen.ID]*SysUser)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(sysuserrole.FieldUserID)
	}
	query.Where(predicate.SysUserRole(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(sysuser.UserRolesColumn), fks...))
	}))
