...
import (
	...
	"github.com/teamsillybees/initra/internal/platform/database"
	"github.com/teamsillybees/initra/internal/platform/idgen"
	"github.com/teamsillybees/initra/internal/platform/logging"
...
func Bootstrap(ctx context.Context, options Options) (*Application, error) {
	...
	do.Provide(injector, func(i *do.Injector) (*utils.BcryptPasswordManager, error) {
		return utils.NewBcryptPasswordManager(0), nil
	})
