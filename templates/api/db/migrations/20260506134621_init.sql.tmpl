...
CREATE TABLE "sys_config" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "config_key" character varying NOT NULL, "config_value" text NOT NULL DEFAULT '', "config_desc" text NULL, "is_builtin" boolean NOT NULL DEFAULT false, "sort_id" bigint NOT NULL DEFAULT 0, PRIMARY KEY ("id"));
...
-- Create index "sysconfig_deleted_at" to table: "sys_config"
CREATE INDEX "sysconfig_deleted_at" ON "sys_config" ("deleted_at");
...
CREATE TABLE "sys_dict_collection" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "is_enable" boolean NOT NULL DEFAULT true, "description" text NULL, "item_length" bigint NULL, "is_builtin" boolean NOT NULL DEFAULT false, "sort_id" bigint NOT NULL DEFAULT 0, PRIMARY KEY ("id"));
...
-- Create index "sysdictcollection_deleted_at" to table: "sys_dict_collection"
CREATE INDEX "sysdictcollection_deleted_at" ON "sys_dict_collection" ("deleted_at");
...
CREATE TABLE "sys_dict_item" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "collection_code" character varying NOT NULL, "code" character varying NOT NULL, "parent_code" character varying NOT NULL DEFAULT '0', "label" character varying NOT NULL, "is_default_value" boolean NOT NULL DEFAULT false, "is_enable" boolean NOT NULL DEFAULT true, "description" text NULL, "sort_id" bigint NOT NULL DEFAULT 0, "collection_id" bigint NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "sys_menu" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "parent_id" bigint NOT NULL DEFAULT 0, "app_id" character varying NULL, "title" character varying NOT NULL, "menu_type" smallint NOT NULL, "route_path" text NULL, "component_path" text NULL, "permission_code" character varying NULL, "icon" character varying NULL, "is_visible" boolean NOT NULL DEFAULT true, "is_cached" boolean NOT NULL DEFAULT true, "sort_id" bigint NOT NULL DEFAULT 0, PRIMARY KEY ("id"));
...
CREATE TABLE "sys_role" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "code" character varying NOT NULL, "name" character varying NOT NULL, "remark" text NULL, "is_builtin" boolean NOT NULL DEFAULT false, "is_enable" boolean NOT NULL DEFAULT true, "sort_id" bigint NOT NULL DEFAULT 0, PRIMARY KEY ("id"));
...
CREATE TABLE "sys_role_menu" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_by" bigint NULL, "created_at" timestamptz NOT NULL, "menu_id" bigint NOT NULL, "role_id" bigint NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE "sys_user" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "created_by" bigint NULL, "updated_by" bigint NULL, "username" character varying NOT NULL, "password_hash" text NOT NULL, "nickname" character varying NULL, "phone" character varying NULL, "email" character varying NULL, "avatar_url" text NULL, "is_super_admin" boolean NOT NULL DEFAULT false, "is_enable" boolean NOT NULL DEFAULT true, "sort_id" bigint NOT NULL DEFAULT 0, PRIMARY KEY ("id"));
...
-- Create index "sysuser_deleted_at" to table: "sys_user"
CREATE INDEX "sysuser_deleted_at" ON "sys_user" ("deleted_at");
...
CREATE TABLE "sys_user_role" ("id" bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY, "deleted_at" timestamptz NULL, "created_by" bigint NULL, "created_at" timestamptz NOT NULL, "role_id" bigint NOT NULL, "user_id" bigint NOT NULL, PRIMARY KEY ("id"));
